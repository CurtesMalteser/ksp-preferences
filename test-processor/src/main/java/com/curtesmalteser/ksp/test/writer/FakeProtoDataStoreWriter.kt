package com.curtesmalteser.ksp.test.writer

import com.curtesmalteser.ksp.visitor.ClassVisitor
import com.curtesmalteser.ksp.writer.BaseWriter
 ...
 */
class FakeProtoDataStoreWriter(
    output: OutputStream,
    ...
    override fun writeClass(declarationName: String) {
        ...
        val className = "${declarationName}Mock"
